...
if __name__ == "__main__":
    ...
    for file_set in dirnames:
        ...
        for f in unique_file_nums:
            ...
            # TOPICS
            image_handler = VideoExporter(camera_topic="/apollo/sensor/camera/front_6mm/image/compressed", export_dir=export_dir, fileset=f)
            ...
            with open (export_dir + str(f) + ".json", 'w') as f:
