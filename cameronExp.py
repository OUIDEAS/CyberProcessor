...
class VideoExporter:
    ...
    def __init__(self, camera_topic, export_dir):
        # Topics
        ...
        self.videWriter = cv2.VideoWriter(export_dir + "ExportedInfo.avi", self.fourcc, 20.0, self.export_dimensions)
...
if __name__ == "__main__":
    ...
    # TOPICS
    image_handler = VideoExporter(camera_topic="/apollo/sensor/camera/front_6mm/image/compressed", export_dir=export_dir)
